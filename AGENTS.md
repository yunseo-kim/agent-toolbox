...
| Catalog index | `catalog/metadata/catalog-index.json`, `catalog/metadata/catalog-index.toon` | Auto-generated; do not hand-edit |
...
- **Index tests**: verify `catalog-index.json` and `catalog-index.toon` are consistent with individual SKILL.md frontmatter.
...
- `catalog/metadata/catalog-index.json` and `catalog/metadata/catalog-index.toon` are auto-generated by `bun run build:index`; do not hand-edit.
