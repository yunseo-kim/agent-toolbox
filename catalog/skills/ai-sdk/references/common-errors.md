...
// O Correct - using typed tool parts (recommended)
{
...
// O Alternative - using isToolUIPart as a catch-all
...
// O Correct - check for input-available or output-available
if (
...
// O Correct - check for output-available
