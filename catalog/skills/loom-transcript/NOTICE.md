...
This file has been adapted from the original n8n `.claude/skills/loom-transcript/SKILL.md` for use
in the awesome-agent-toolbox catalog. Changes include:

- Added catalog frontmatter metadata (domain, tags)
- Reformatted for catalog SKILL.md schema compliance
