...
[langgenius/dify](https://github.com/langgenius/dify) (`.agents/skills/component-refactoring`),
...
This skill has been adapted from the original Dify component-refactoring skill
for use in the awesome-agent-toolbox catalog. Changes include:

- Removed all Dify-specific CLI commands (`pnpm refactor-component`, `pnpm analyze-component`)
- Removed Dify-specific file path references (`web/app/components/...`)
- Removed Dify-specific sections (Workflow Node Components, Configuration Components, Tool/Plugin Components)
- Generalized "Dify Convention" guidance to universal React conventions
- Generalized React Query examples to use standard patterns without project-specific namespacing
- Retained and generalized all six core refactoring patterns for universal React applicability
- Adapted reference documents (complexity-patterns, component-splitting, hook-extraction) to remove project-specific code while preserving universal patterns
