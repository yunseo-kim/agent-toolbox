...
This file has been adapted from the original n8n `.claude/skills/reproduce-bug/SKILL.md` for use
in the awesome-agent-toolbox catalog. Changes include:

- Added catalog frontmatter metadata (domain, subdomain, tags)
- Removed n8n-specific test routing table (package paths, n8n testing tools)
- Replaced with a generic test strategy table applicable to any project
- Removed n8n-specific commands (pnpm, pushd/popd references)
- Generalized terminology throughout
