...
- **Verbose logs**: `TORCH_LOGS="+dynamo,+export" python script.py 2>&1 | tlparse`
...
- [torch.export deep dive](guides/torch-export.md) -- tracing internals, symbolic shapes, guards, control flow operators, common failure patterns, and making untraceable code traceable
