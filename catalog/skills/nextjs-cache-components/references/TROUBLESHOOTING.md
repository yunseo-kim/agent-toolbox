...
> **See also**: Pattern 1 (Static + Cached + Dynamic Page) in [PATTERNS.md](PATTERNS.md) shows the foundational Suspense boundary pattern.
...
> **See also**: Pattern 4 (Cached Data Fetching Functions) in [PATTERNS.md](PATTERNS.md) shows reusable cached data fetcher patterns.
