...
This file has been adapted from the original n8n `.claude/skills/content-design/SKILL.md` for use
in the awesome-agent-toolbox catalog. Changes include:

- Added catalog frontmatter metadata (domain, subdomain, tags)
- Removed n8n-specific terminology glossary (workflow, node, trigger, execution, credential, canvas, connection, pin)
- Removed n8n-specific conventions (lowercase "n8n", "n8n Cloud", Node capitalization rules)
- Removed n8n-specific file paths and i18n key naming conventions
- Removed n8n-specific audit grep target files
- Generalized product-specific examples to be tool-agnostic
