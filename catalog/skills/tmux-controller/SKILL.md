...
- Monitoring AI assistant sessions in tmux
...
- Running one-off shell commands - use shell execution directly
- Starting new background processes - use background execution
- Non-interactive scripts - use direct shell execution
